...
/**
 * InlineLoader - Standardized inline loading component for the web platform
 * Matches the visual style of the web app's LoadingOverlay
 */
export function InlineLoader({
    visible = true,
    message = 'SYNCHRONIZING_SESSION...'
}: InlineLoaderProps) {
    if (!visible) return null;

    return (
        <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-[#05070A]/80 backdrop-blur-md">
